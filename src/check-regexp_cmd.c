/*
  ...
  /bin/gengetopt --input ../../src/check-regexp_cmd.ggo --unamed-opts -F check-regexp_cmd --output-dir=../../src 
...
const char *gengetopt_args_info_usage = "Usage: check-regexp REGULAR_EXPRESSION STRING1 STRING2 ...";
